...
type (
	IPlayerTransactionRepository interface {
		FirstByField(pctx context.Context, field string, expected any) (*player.PlayerTransaction, error)
		ExistsByField(pctx context.Context, field string, expected any) (bool, error)
		Create(pctx context.Context, req player.PlayerTransaction) (string, error)
	}
...
func (r *playerTransactionRepository) FirstByField(pctx context.Context, field string, expected any) (*player.PlayerTransaction, error) {
	db := r.dbConn()
	...
	var result player.PlayerTransaction
	if err := col.FindOne(
		pctx,
...
func (r *playerTransactionRepository) Create(pctx context.Context, req player.PlayerTransaction) (string, error) {
